    ...
    <div class="transaction-details">
        <form action="process_transaction.php" method="POST">
            ...
            <select name="transaction_type" required>
                ...
                <!-- Add more transaction types as needed // required readonly-->
            </select><br>
        <label for="charged_amount">Charged Amount:</label>
        <input type="text" name="charged_amount" value="<?php echo $charged_amount;?>" ><br><br>

        <label for="flight_id">Flight ID:</label>
        <input type="text" name="flight_id" value="<?php echo $flight_id; ?>" ><br><br>
